...
def run_training():
  ...
  with tf.Graph().as_default():
    ...
    image, label = inputs(train=True, num_epochs=FLAGS.num_epochs)
    ...
    try:
      ...
      while not coord.should_stop():
        ...
        images, labels = sess.run(feed_inputs_data(image=image, label=label,train=True, batch_size=FLAGS.batch_size,
